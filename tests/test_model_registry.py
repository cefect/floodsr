...
@pytest.mark.parametrize(
    "show_progress",
    [
        pytest.param(True, id="progress_default"),
        pytest.param(False, id="progress_disabled"),
    ],
)
@pytest.mark.fast
def test_fetch_model_returns_cached_path(tmp_path: Path, models_manifest_fp: Path, show_progress: bool):
